...
const PAYMENT_PROVIDER_NOTE = {
  en: "Our order process is conducted by our online reseller Stripe. Stripe is the payment processor for all our orders. Stripe provides all customer service inquiries and handles returns.",
  no: "Vår bestillingsprosess gjennomføres av vår nettforhandler Stripe. Stripe er payment processor for alle våre bestillinger. Stripe håndterer alle kundeservicehenvendelser og returer.",
  de: "Unser Bestellprozess wird von unserem Online-Reseller Stripe abgewickelt. Stripe ist payment processor für alle unsere Bestellungen. Stripe bearbeitet alle Kundenanfragen und Retouren.",
  sv: "Vår beställningsprocess hanteras av vår onlineåterförsäljare Stripe. Stripe är payment processor för alla våra beställningar. Stripe hanterar alla kundtjänstärenden och returer.",
  fr: "Notre processus de commande est géré par notre revendeur en ligne Stripe. Stripe est le payment processor pour toutes nos commandes. Stripe gère toutes les demandes de service client et les retours.",
};
...
const en = (): Record<LegalDocKey, LegalDocContent> => ({
  terms: {
    ...
    sections: [
      ...
      { id: "subscriptions", title: "Subscriptions and billing", body: <><p>Some AUTOVERE features are available through a paid subscription. Pricing, billing cycles and renewal terms are presented on the <Link to="/pricing">Pricing page</Link> and at checkout.</p><p>Subscriptions renew automatically until cancelled. You can cancel at any time — see the <Link to="/legal/subscriptions">Subscription Terms</Link> for details.</p><p>{PAYMENT_PROVIDER_NOTE.en}</p></> },
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "What we collect", body: <>
        ...
        <p><strong>Billing data</strong> — when you subscribe, our payment provider <strong>Stripe, Inc.</strong> ("Stripe") acts as payment processor. Stripe hosts the checkout, processes your payment, calculates and remits sales tax/VAT, prevents fraud, and issues invoices. We never see or store your full card details.</p>
      ...
      { id: "sharing", title: "Who we share with", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — our payment processor for all paid subscriptions. Stripe receives data necessary to process your payment, manage your subscription, calculate and remit sales tax/VAT, prevent fraud, and issue invoices. Stripe acts as an independent data controller for this processing. See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripe's Privacy Policy</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Hva vi samler inn", body: <>
        ...
        <p><strong>Faktureringsdata</strong> — når du abonnerer, opptrer vår betalingsleverandør <strong>Stripe, Inc.</strong> ("Stripe") som payment processor. Stripe drifter kassen, behandler betalingen, beregner og innbetaler moms/VAT, forhindrer svindel og utsteder fakturaer. Vi ser eller lagrer aldri dine fullstendige kortdata.</p>
      ...
      { id: "sharing", title: "Hvem vi deler med", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — vår payment processor for alle betalte abonnementer. Stripe mottar data nødvendig for å behandle betalingen din, administrere abonnementet, beregne og innbetale moms/VAT, forhindre svindel og utstede fakturaer. Stripe opptrer som selvstendig behandlingsansvarlig for denne behandlingen. Se <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes personvernerklæring</a>.</p>
...
const de = (): Record<LegalDocKey, LegalDocContent> => ({
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Was wir erheben", body: <>
        ...
        <p><strong>Abrechnungsdaten</strong> — bei einem Abonnement fungiert unser Zahlungsanbieter <strong>Stripe, Inc.</strong> ("Stripe") als payment processor. Stripe hostet die Kasse, verarbeitet Zahlungen, berechnet und führt Umsatzsteuer/MwSt. ab, verhindert Betrug und stellt Rechnungen aus. Wir sehen oder speichern niemals Ihre vollständigen Kartendaten.</p>
  ...
  subscriptions: {
    ...
    sections: [
      ...
      { id: "tax", title: "Steuern", body: <p>Umsatzsteuer, MwSt. und ähnliche Steuern werden an der Kasse basierend auf Ihrem Rechnungsstandort berechnet und von unserem Zahlungspartner als payment processor abgewickelt.</p> },
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "sharing", title: "Vilka vi delar med", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — vår payment processor för alla betalda prenumerationer. Stripe får data som krävs för att behandla betalningen, hantera prenumerationen, beräkna och betala moms/VAT, förhindra bedrägerier och utfärda fakturor. Stripe agerar som självständigt personuppgiftsansvarig för denna behandling. Se <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes integritetspolicy</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Ce que nous collectons", body: <>
        ...
        <p><strong>Données de facturation</strong> — lorsque vous vous abonnez, notre prestataire de paiement <strong>Stripe, Inc.</strong> ("Stripe") agit en tant que payment processor. Stripe héberge le paiement, traite votre paiement, calcule et reverse la TVA, prévient la fraude et émet les factures. Nous ne voyons ni ne stockons jamais vos coordonnées bancaires complètes.</p>
