...
const STRIPE_PAYMENT_NOTE = {
  en: "Payments are processed securely by Stripe. Stripe provides payment infrastructure, fraud prevention, and compliance services.",
  no: "Betalinger behandles sikkert av Stripe. Stripe tilbyr betalingsinfrastruktur, svindelforebygging og overholdelsestjenester.",
  de: "Zahlungen werden sicher durch Stripe verarbeitet. Stripe bietet Zahlungsinfrastruktur, Betrugsprävention und Compliance-Dienste.",
  sv: "Betalningar behandlas säkert av Stripe. Stripe tillhandahåller betalningsinfrastruktur, bedrägeriförebyggande och efterlevnadstjänster.",
  fr: "Les paiements sont traités en toute sécurité par Stripe. Stripe fournit des services d'infrastructure de paiement, de prévention de la fraude et de conformité.",
};
...
const en = (): Record<LegalDocKey, LegalDocContent> => ({
  terms: {
    ...
    sections: [
      ...
      { id: "subscriptions", title: "Subscriptions and billing", body: <><p>Some AUTOVERE features are available through a paid subscription. Pricing, billing cycles and renewal terms are presented on the <Link to="/pricing">Pricing page</Link> and at checkout.</p><p>Subscriptions renew automatically until cancelled. You can cancel at any time — see the <Link to="/legal/subscriptions">Subscription Terms</Link> for details.</p><p>{STRIPE_PAYMENT_NOTE.en}</p></> },
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "What we collect", body: <>
        ...
        <p><strong>Billing data</strong> — when you subscribe, payments are processed by <strong>Stripe, Inc.</strong> Stripe hosts the checkout, processes your payment, prevents fraud, and issues receipts. We never see or store your full card details.</p>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Payment method details (card number, expiry, CVC, or digital wallet token)</li>
          <li>Bank or card-issuer information used for authorisation and 3-D Secure</li>
          <li>IP address and approximate geolocation (used for fraud scoring)</li>
      ...
      { id: "sharing", title: "Who we share with", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — our payment processor for all paid subscriptions. Stripe receives data necessary to process your payment, manage your subscription, prevent fraud, and issue receipts. Stripe acts as an independent data controller for this processing. See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripe's Privacy Policy</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Hva vi samler inn", body: <>
        ...
        <p><strong>Faktureringsdata</strong> — når du abonnerer, behandles betalinger av <strong>Stripe, Inc.</strong> Stripe drifter kassen, behandler betalingen, forhindrer svindel og utsteder kvitteringer. Vi ser eller lagrer aldri dine fullstendige kortdata.</p>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Betalingsmetodedetaljer (kortnummer, utløp, CVC, eller digital lommebok-token)</li>
          <li>Bank- eller kortutsteders informasjon brukt for autorisering og 3-D Secure</li>
          <li>IP-adresse og omtrentlig geolokalisering (for svindelvurdering)</li>
      ...
      { id: "sharing", title: "Hvem vi deler med", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — vår betalingsbehandler for alle betalte abonnementer. Stripe mottar data nødvendig for å behandle betalingen din, administrere abonnementet, forhindre svindel og utstede kvitteringer. Stripe opptrer som selvstendig behandlingsansvarlig for denne behandlingen. Se <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes personvernerklæring</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Was wir erheben", body: <>
        ...
        <p><strong>Abrechnungsdaten</strong> — bei einem Abonnement werden Zahlungen von <strong>Stripe, Inc.</strong> verarbeitet. Stripe hostet die Kasse, verarbeitet Zahlungen, verhindert Betrug und stellt Belege aus. Wir sehen oder speichern niemals Ihre vollständigen Kartendaten.</p>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Zahlungsmittel-Details (Kartennummer, Ablauf, CVC oder Digital-Wallet-Token)</li>
          <li>Bank- oder Kartenausstellerinformationen für Autorisierung und 3-D Secure</li>
          <li>IP-Adresse und ungefähre Geolokalisierung (für Betrugsprüfung)</li>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Abonnementstatus (<code>trialing</code>, <code>active</code>, <code>past_due</code>, <code>canceled</code>)</li>
          <li>Aktuelles Abrechnungszeitraum-Start- und Enddatum</li>
          <li>Ob das Abonnement zum Periodenende gekündigt wird</li>
          <li>Umgebungsflag (<code>test</code> oder <code>live</code>)</li>
        ...
        <p>Wir verwenden diese Daten zur Bereitstellung Ihres Abonnements, zur Freischaltung von Premium-Funktionen, zum Versand von Verlängerungs- und Belegbenachrichtigungen, zur Bearbeitung von Supportanfragen und zur Erfüllung unserer Buchhaltungs- und Steuerpflichten. Siehe <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes Datenschutzerklärung</a> für die Verarbeitung durch Stripe.</p>
      ...
      { id: "sharing", title: "Mit wem wir teilen", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — unser Zahlungsverarbeiter für alle bezahlten Abonnements. Stripe erhält die zur Zahlungsabwicklung, Abonnementverwaltung, Betrugsprävention und Belegausstellung notwendigen Daten. Stripe handelt für diese Verarbeitung als unabhängiger Verantwortlicher. Siehe <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes Datenschutzerklärung</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Vad vi samlar in", body: <>
        ...
        <p><strong>Faktureringsdata</strong> — när du prenumererar behandlas betalningar av <strong>Stripe, Inc.</strong> Stripe driver kassan, behandlar betalningar, förhindrar bedrägerier och utfärdar kvitton. Vi ser eller lagrar aldrig dina fullständiga kortuppgifter.</p>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Betalmetoduppgifter (kortnummer, utgång, CVC, eller digital plånbokstoken)</li>
          <li>Bank- eller kortutgivarinformation för auktorisering och 3-D Secure</li>
          <li>IP-adress och ungefärlig geolokalisering (för bedrägeribedömning)</li>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Prenumerationsstatus (<code>trialing</code>, <code>active</code>, <code>past_due</code>, <code>canceled</code>)</li>
      ...
      { id: "sharing", title: "Vilka vi delar med", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — vår betalningsbehandlare för alla betalda prenumerationer. Stripe får data som krävs för att behandla betalningen, hantera prenumerationen, förhindra bedrägerier och utfärda kvitton. Stripe agerar som självständigt personuppgiftsansvarig för denna behandling. Se <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">Stripes integritetspolicy</a>.</p>
  ...
  privacy: {
    ...
    sections: [
      ...
      { id: "what", title: "Ce que nous collectons", body: <>
        ...
        <p><strong>Données de facturation</strong> — lorsque vous vous abonnez, les paiements sont traités par <strong>Stripe, Inc.</strong> Stripe héberge le paiement, traite votre paiement, prévient la fraude et émet les reçus. Nous ne voyons ni ne stockons jamais vos coordonnées bancaires complètes.</p>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Détails du moyen de paiement (numéro de carte, expiration, CVC, ou jeton de portefeuille numérique)</li>
          <li>Informations de la banque ou de l'émetteur pour autorisation et 3-D Secure</li>
          <li>Adresse IP et géolocalisation approximative (pour évaluation de fraude)</li>
        ...
        <ul className="list-disc pl-6 space-y-1 mb-4">
          ...
          <li>Statut d'abonnement (<code>trialing</code>, <code>active</code>, <code>past_due</code>, <code>canceled</code>)</li>
          ...
          <li>Drapeau d'environnement (<code>test</code> ou <code>live</code>)</li>
      ...
      { id: "sharing", title: "Avec qui nous partageons", body: <>
        ...
        <p><strong>Stripe, Inc.</strong> — notre prestataire de paiement pour tous les abonnements payants. Stripe reçoit les données nécessaires au traitement du paiement, à la gestion de l'abonnement, à la prévention de la fraude et à l'émission de reçus. Stripe agit en tant que responsable de traitement indépendant pour ce traitement. Voir <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="underline">la politique de confidentialité de Stripe</a>.</p>
