const en = {
  ...
  pages: {
    ...
    pricing: {
      ...
      checkout_cancelled: "Checkout was cancelled. You can try again anytime.",
      portal_returned: "Returned from the customer portal.",
      success_redirecting: "Redirecting to home in {{seconds}} seconds.",
      success_go_home: "Go to home",
      checkout_error_auth: "You must be signed in to start checkout.",
      checkout_error_payload: "Invalid checkout request. Refresh and try again.",
      checkout_error_price: "The selected subscription price is invalid. Contact support.",
      checkout_error_currency: "Subscriptions are currently available in EUR only.",
      checkout_error_mode: "Stripe environment mismatch. Verify test/live configuration.",
      checkout_error_url: "Could not generate a valid checkout URL. Please try again.",
      checkout_error_request: "Checkout could not be opened. Please try again.",
      reassurance: {
        t1: "No data resold",
